			...
			<div className="relative w-full h-full max-w-2xl px-4 md:h-auto">
				...
				<div className="relative bg-white rounded-lg mt-[200px] shadow dark:bg-gray-800">
					...
					<div className="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
						<button className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="submit" >Create Client</button>
					</div>
					</form>
				</div>
			</div>
...
export default connect(null, { loadEventsDashboard })(CreateClient);
